        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-white/45 text-sm">
              {visibleBookings.length} booking{visibleBookings.length === 1 ? '' : 's'} visible
            </p>
          </div>
          <button
            type="button"
      ...
      {visibleBookings.length > 0 ? (
        <div className="space-y-3">
          {visibleBookings.map((booking) => {
            ...
            const canCancel = isUpcoming && booking.status !== 'rejected' && booking.status !== 'cancelled';
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        ...
                        style={{
                          ...
                          color: isUpcoming ? '#7dd3fc' : 'rgba(255,255,255,0.6)',
                        }}
                      >
                  ...
                  {canCancel && (
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-2xl px-4 py-3 text-sm font-semibold self-start"
                      style={{
        ...
        <GlassCard className="text-center py-12">
          <p className="text-white text-lg font-semibold">
            {bookings.length === 0 ? "You don't have any bookings yet" : 'No approved bookings found'}
          </p>
